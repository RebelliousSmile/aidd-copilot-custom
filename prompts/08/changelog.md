...
argument-hint: <version> (e.g. v1.2.0) — omit to auto-detect next version
---
...
If a version is provided in the prompt, use it; otherwise infer the next version from commit types.
...
3. If a version was provided, use it; otherwise infer next semver from commit types:
